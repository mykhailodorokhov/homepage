            ...
            <div className="content-row">
                ...
                <div className="content-row">
                    ...
                    <div className="column">
                        <p>
                            ...
                            MTAT.03.229 Enterprise Systems Integration<br />
                ...
                <div className="content-row">
                    ...
                    <div className="column text">
                        <p>Developing a research project tool related to privacy.</p>
                    </div>
                </div>
                ...
                <div className="content-row">
                    ...
                    <div className="column">
                        <p>
                            ...
                            (<a href="https://tartu.postimees.ee/7398870/valistudengina-eestisse-tulnud-it-mees-opetab-gumnasiste-koodi-kirjutama" target="_blank" rel="noopener noreferrer">Tartu Postimees article</a>;{" "}
                            <a href="https://jupiterpluss.err.ee/1608348899/kofe" target="_blank" rel="noopener noreferrer">ETV+ interview</a>)
                        </p>
                    </div>
                </div>
